...
import 'package:handy_dandy_app/bindings/hand_rock_binding.dart';
...
import 'package:handy_dandy_app/screens/hand_rock/main/hand_rock_main_screen.dart';
...
import '../screens/hand_rock/ready/hand_rock_ready_screen.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(
        name: Routes.ONLINE_GAME,
        page: () => OnlineMainGameScreen(),
        binding: OnlineGameBinding()),
    GetPage(
    ...
    GetPage(
        name: Routes.READY_HAND_ROCK,
        page: () => HandRockReadyScreen(),
        binding: HandRockBinding()),
    GetPage(name: Routes.MAIN_HAND_ROCK, page: () => HandRockMainScreen())
  ];
}
